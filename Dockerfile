...
RUN set -x \
    ...
    && mv /tmp/v2ray/v2ray-linux-64/v2ray /usr/bin \
    && mv /tmp/v2ray/v2ray-linux-64/v2ctl /usr/bin \
    && mv /tmp/v2ray/v2ray-linux-64/geoip.dat /usr/bin \
    && mv /tmp/v2ray/v2ray-linux-64/geosite.dat /usr/bin \
